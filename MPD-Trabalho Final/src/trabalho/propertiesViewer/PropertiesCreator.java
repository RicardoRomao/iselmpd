...
public class PropertiesCreator<T> extends AbstractPropertiesForm<T> {
    ...
    public PropertiesCreator(T t, ActionListener listener) {
        super(t);
        if (listener != null)
            addUpdateListener(listener);
        _addBtn.setVisible(false);
        add(_addBtn,BorderLayout.SOUTH);
        doPopulatePropsForm();
    }
    ...
    public void addUpdateListener(ActionListener listener) {
        if (listener != null) {
            _addBtn.setVisible(true);
            _addBtn.addActionListener(listener);
        }
    }
